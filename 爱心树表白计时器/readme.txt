...
背景音乐修改：
将你准备好的音乐文件放到audio目录下，删除之前的音乐文件(bgm1.mp3)，然后把你的音乐文件名字修改为bgm1.mp3即可。

修改开始爱心桃旁边的文字：js文件夹love.js文件
ctx.fillText("[ X X X ]", 23, 10);
双引号里面就是，自行修改就行。

修改网页下面时间文字中"第""年""月""天"等文字：js文件夹functions.js文件
...
together.setFullYear(2015,(6-1),(20-1)); //年月日
together.setHours(5);  //时
together.setMinutes(20);  //分
together.setSeconds(0);  //秒前一位
together.setMilliseconds(0);  //秒前两位
把中间的数字修改成对应的时间就行，上面表示的是2015年6月20号5时20分0秒
